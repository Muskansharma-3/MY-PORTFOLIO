...
const About = () => {
  return (
    <div
      className="bg-gradient-to-br from-gray-100 to-white min-h-screen p-8"
      id="about"
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-14">
        
        {/* Profile Card (Left Side) */}
        <div className="bg-white shadow-xl rounded-2xl p-8 text-center md:w-1/3 w-full border border-gray-200 transform transition-transform duration-300 hover:scale-105">
          <img
            src="/profile.jpg"
            alt="Muskan Sharma"
        ...
        <div className="md:w-2/3 w-full bg-white rounded-2xl shadow-xl px-8 py-10 border border-gray-200 transform transition-transform duration-300 hover:scale-105">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            Hi, I’m <span className="text-[#00bcd4] font-semibold">Muskan Sharma</span>, a passionate Computer Science student who finds joy in merging <span className="font-medium">logic</span> with <span className="font-medium">design</span>.
          </p>

          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            I love building things with impact—be it through <span className="font-medium">clean code</span>, <span className="font-medium">modern UIs</span>, or solving real-world problems with scalable solutions.
          </p>
